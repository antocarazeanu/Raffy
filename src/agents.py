...
agent_investitii_juridic = Agent(
    ...
    instructions=(
        ...
        "Raspunde mereu in cel mult o fraza."
...
agent_credite_fizic = Agent(
    ...
    instructions=(
        ...
        "1. Daca utilizatorul nu a adresat inca o intrebare specifica, intreaba-l ce doreste sa afle."
        "2. Daca utilizatorul indica faptul ca vrea sa reia discutia de la inceput, transfera-l la agentul de triaj."
        "3. Daca raspunsul catre intrebarea utilizatorului nu poate fi gasita in contextul utilizatorului, anunta-l pe utilizator ca nu detii aceste informatii si intreaba-l cum il poti ajuta cu altceva legat de banca Raiffeisen."
        "4. Daca totusi intrebarea utilizatorului este legata de credite, ofera un raspuns bazat strict pe contextul ce urmeaza."
    ),
    tools=[transfer_inapoi_la_triaj],
...
agent_persoana_juridica = Agent(
    ...
    instructions=(
        ...
        "Respecta urmatoarea rutina cu utilizatorul:"
        "1. Daca utilizatorul nu a adresat inca o intrebare specifica, intreaba-l ce doreste sa afle."
        #"2. Daca utilizatorul indica faptul ca este, de fapt, o persoana fizica, transfera-l la agentul de persoana fizica."
        "2. Daca utilizatorul indica faptul ca vrea sa reia discutia de la inceput, transfera-l la agentul de triaj."
...
agent_persoana_fizica = Agent(
    ...
    instructions=(
        ...
        "Respecta urmatoarea rutina cu utilizatorul:"
        "1. Daca utilizatorul nu a adresat inca o intrebare specifica, intreaba-l ce doreste sa afle."
        #"2. Daca utilizatorul indica faptul ca este, de fapt, o persoana juridica, transfera-l la agentul de persoana juridica."
        "2. Daca utilizatorul indica faptul ca vrea sa reia discutia de la inceput, transfera-l la agentul de triaj."
        "3. Daca utilizatorul a adresat deja o intrebare, incearca sa identifici daca aceasta este legata de unul dintre urmatoarele domenii:"
        " - Asigurari"
        " - Credite"
...
# triage agent
## ensurance knowledgebase
# credit knowledgebase
# account and cards knowledgebase
# mobile apps knowledgebase
# savings knowledgebase
# investment knowledgebase
